...
After our own experience but also some reading (X) , we decided on two "subjective" criteria for evaluating text generation:
...
We also read about metrics such as perplexity to evaluate text generation. However, these metrics are quite hard to implement and not always the best way to evaluate the predictions (X). However, an extension of our work could be to implement them to have a better understanding. 
...
Evaluation criteria: https://www.sciencedirect.com/science/article/pii/S1319157820303360
metrics: https://www.sciencedirect.com/science/article/pii/S1319157820303360
