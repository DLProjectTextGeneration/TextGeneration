...
## 1) Generating text with Neural Networks: Theory
### a) The models
...
## 2) Generating text with Neural Networks: Practice
### a) Our data and data preparation 
...
### b) fitting the model
### c) Generating texts: outputs and insights
